...
PICS = (environ.get('PICS', 'https://envs.sh/1Mf.jpg https://envs.sh/Rqv.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002064170254'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001750077160 -1001541833234').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001514116019')
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://Vijay:Vijay@vijay.oex6o.mongodb.net/?retryWrites=true&w=majority")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://Vijay2:Vijay2@vijay2.xzpth.mongodb.net/?retryWrites=true&w=majority")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://Vijay1:Vijay1@vijay1.1rzve.mongodb.net/?retryWrites=true&w=majority")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://Autoclone:Autoclone@autoclone.v97cs.mongodb.net/?retryWrites=true&w=majority") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'fileclone12') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+ipiam4tiR4E0ZTE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Ellisa_movies_hub')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ellisa_support_group') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ellisa_support')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'b8e634ced771f52343a7879ad932313a3e8ee48c')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://youtube.com/shorts/lj-jFNf-Hn8?feature=share')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_download_urlsopen/71') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
